...
| clearml-l4-best-config-dropout-04 | 2026-03-19 | bilstm | 100 | 64 | 1e-3 | 512 | 0.4 | 0 (all) | 0 (all) | yes (p=25) | 8.3 | 0.369 | 0.883 | 77 | New best val CER; dropout 0.3→0.4 on best config (batch=64, hidden=512); val CER 0.369 (vs 0.372), gap=0.232 (vs 0.284 target — both targets met); LR decayed to 1.953125e-6 (9× reductions); train CER 0.137 vs val 0.369 | clearml-l4-best-config-dropout-04_d769464f |
